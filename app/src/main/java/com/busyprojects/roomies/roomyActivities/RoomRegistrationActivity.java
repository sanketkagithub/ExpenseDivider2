...
*/
        ...
        if (CheckInternetReceiver.isOnline(this)) {
            ...
            if (roomNo.equals("")) {
                ...
                if (CheckInternetReceiver.isOnline(context)) {
                    checkNgoToRoomyRegActivity(roomNo);
                } else {
    ...
    void saveRoomyMobileList(final String mobileLogged) {

        if (CheckInternetReceiver.isOnline(this)) {
            dialogEffect.showDialog();
            db_ref.child(Helper.ROOMY).addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    // checkNgoToRoomyRegActivity(mobileLogged);
    ...
    void checkNgoToRoomyRegActivity(final String roomNo) {
        dialogEffect.showDialog();
